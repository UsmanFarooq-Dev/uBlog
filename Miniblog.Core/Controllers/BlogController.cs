namespace Miniblog.Core.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> Category(string category, int page = 0)
        {
            ...
            return this.View("~/Views/Blog/PostList.cshtml", filteredPosts.AsAsyncEnumerable());
        }
        ...
        [Route("/blog/{page:int?}")]
        [OutputCache(Profile = "default")]
        public async Task<IActionResult> PostList([FromRoute] int page = 0)
        {
            // get published posts.
            ...
            return this.View("~/Views/Blog/PostList.cshtml", filteredPosts);
        }
